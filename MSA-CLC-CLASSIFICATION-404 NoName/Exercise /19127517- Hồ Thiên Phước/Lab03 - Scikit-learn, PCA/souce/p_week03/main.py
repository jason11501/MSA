...
data = pd.read_csv("data/ruou.csv")
...
pd.plotting.scatter_matrix(data.loc[:, "V2":"V12"], diagonal="kde", figsize=(20, 15))
plt.show()

for i in range(2, 12):
    sns.lmplot(x="V" + str(i), y="V" + str(i + 1), data=data, hue="V1", fit_reg=False)

ax = data[["V2", "V3", "V4", "V5", "V6", "V7", "V8", "V9", "V10", "V11", "V12"]].plot(figsize=(20, 15))
...
ax = data[["V12"]].plot(figsize=(20, 15))
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
